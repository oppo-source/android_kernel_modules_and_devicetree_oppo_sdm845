...
enum oppo_usbc_jack{
	OPPO_USBC_JACK_INVALID = -1,
	OPPO_USBC_JACK_NONE,
	OPPO_USBC_JACK_HEADSET,
	OPPO_USBC_JACK_HEADPHONES,
	OPPO_USBC_JACK_HIGH_HPH,
	OPPO_USBC_JACK_GND_MIC_SWAP,
	OPPO_USBC_JACK_ANC,
	OPPO_USBC_JACK_SELFSTICK,
	OPPO_USBC_JACK_TIELINE,
	OPPO_USBC_JACK_NO_GND_MIC_SWAP,
	OPPO_USBC_JACK_HPL_HPR_GND
};
#endif /* OPLUS_ARCH_EXTENDS */
