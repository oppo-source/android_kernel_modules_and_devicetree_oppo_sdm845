				  ...
				  struct snd_ctl_elem_value *ucontrol)
{
	...
	if ((value < 0  || value >= sizeof(ia6xx_bypass_mode_values)/sizeof(ia6xx_bypass_mode_values[0]))){
					...
					struct snd_ctl_elem_value *ucontrol)
{
	...
	if (value != IA_ROUTE_SELECTED_NONE &&
			(value >= 0  && value < sizeof(ia6xx_select_route_values)/sizeof(ia6xx_select_route_values[0]))){
